Gem::Specification.new do |s|
  ...
  s.date = %q{2008-05-29}
  s.description = %q{Merb plugin that allows templates (views) to be defined in the same file as the controller}
  ...
  s.summary = %q{Merb plugin that allows templates (views) to be defined in the same file as the controller}
